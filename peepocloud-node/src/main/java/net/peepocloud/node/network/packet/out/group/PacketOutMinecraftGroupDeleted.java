...
public class PacketOutMinecraftGroupDeleted extends Packet {

    @Getter
    private String name;

    public PacketOutMinecraftGroupDeleted(String name) {
        super(2);
        this.name = name;
    }

    public PacketOutMinecraftGroupDeleted(int id) {
        super(id);
    }
