...
/**
 * This event is called every time a bungee starts and the PeepoCloud Plugin is copied to its "plugins" folder.
...
@Getter
@Setter
public class BungeeCordPluginCopyEvent extends ProcessEvent {

    private InputStream inputStream;
    private Path target;

    public BungeeCordPluginCopyEvent(CloudProcess cloudProcess, InputStream inputStream, Path target) {
        super(cloudProcess);
