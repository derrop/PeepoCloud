...
import net.nevercloud.node.api.event.process.bungee.BungeeCordStartupFileCopyEvent;
import net.nevercloud.node.api.event.process.server.MinecraftServerStartupFileCopyEvent;
